	...
	return jQuery(`
      <div class="tooltip-textbox">
        ...
        <div class="tooltip-img">
          <img src="https://us.nanoscientific.org/wp-content/uploads/2021/07/${model}-tooltip.png" alt="${model}-tooltip-picture" />  
        </div>
      </div>
      `);
}
...
function generateModalImages(model, last, center) {
	...
	for (var i = 0; i <= last; i++) {
		...
		if (i === center) {
			$img = jQuery(`
      <img src="https://us.nanoscientific.org/wp-content/uploads/2021/07/${model}_${img_num}.jpg" alt="${model}-3d" class="modal-image-switch image-active">
      `);
		} else {
			$img = jQuery(`
      <img src="https://us.nanoscientific.org/wp-content/uploads/2021/07/${model}_${img_num}.jpg" alt="${model}-3d" class="modal-image-switch">
      `);
		}
